...
const Br = Sentiment.Bearish;
const N = Sentiment.Neutral;
...
const sampleNews = [
  {
    ...
    sentiment: B,
    impactSectors: ["Technology", "Financials", "Real Estate"],
    actionableAdvice:
  ...
  },
  {
    ...
    sentiment: Br,
    impactSectors: ["Technology", "Materials", "Industrials"],
    actionableAdvice:
  ...
  },
  {
    ...
    sentiment: B,
    impactSectors: ["Technology", "Consumer Discretionary"],
    actionableAdvice:
  ...
  },
  {
    ...
    sentiment: N,
    impactSectors: ["Financials", "Real Estate"],
    actionableAdvice:
